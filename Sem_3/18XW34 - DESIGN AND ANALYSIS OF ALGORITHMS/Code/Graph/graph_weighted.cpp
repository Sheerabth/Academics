...
{
public:
    map<int, set<int, int>> adjacencyList;
    void insert(int, int, set<pairs>);
...
void Graph::insert(int value, int weight, set<int, int> connectedNodes)
{
    map<int, set<int, int>> :: iterator iterator = adjacencyList.find(value);
    if (iterator == adjacencyList.end())
        adjacencyList.insert(pair<int, set<int, int>>(value, connectedNodes));
    else
    ...
    {
        map<int, set<int, int>>::iterator iterator = adjacencyList.find(connectedNode);
        if (iterator != adjacencyList.end())
            iterator->second.insert({value, weight});
        else{
            set<int, int> connected({value, weight});
            adjacencyList.insert(pair<int, set<int, int>>(connectedNode, connected));
        }
    }
}
